---
title: Google Maps Hand Gesture Control Examples
description: Interactive demos and code examples for Google Maps hand gesture controls. Try basic setup, sensitivity tuning, custom webcam overlays, and toggle controls directly in your browser.
head:
  - - meta
    - property: og:title
      content: Google Maps Hand Gesture Control Examples - Map Gesture Controls
  - - meta
    - property: og:description
      content: Interactive demos and code examples for Google Maps hand gesture controls. Basic setup, sensitivity tuning, custom overlays, and toggle controls.
  - - meta
    - property: og:url
      content: https://sanderdesnaijer.github.io/map-gesture-controls/google-maps/examples
---

# Google Maps Gesture Control Examples

---
title: Architecture Overview of Map Gesture Controls
description: Explore the internal architecture of Map Gesture Controls. Learn how webcam frames flow through MediaPipe hand tracking, gesture classification, state management, and into map interactions.
head:
  - - meta
    - property: og:title
  ...
  - - meta
    - property: og:description
      content: Internal architecture of Map Gesture Controls. Data flow from webcam through MediaPipe hand tracking, gesture classification, and map interactions.
  - - meta
    - property: og:url

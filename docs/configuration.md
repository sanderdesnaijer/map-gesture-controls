...
| `rotateDeadzoneRad`      | `number` | `0.001` | Minimum change in the wrist-to-wrist angle (radians) required to emit a rotate delta. Lower values make rotation respond to smaller wrist tilts; higher values filter out micro jitter. |
